...
export default function () {
    ...
    async function checkToken () {
        ...
        const instanceInfo = await validateToken(token, !userAccountValue);
    ...
    function _addInstance () {
        ...
        addInstance({ token, bot: !userAccountValue, ...instancePreviewInfo });
    ...
    async function connectInstance (id) {
        ...
        const client = await createClient({ token: instance?.token, bot: instance?.bot });
            ...
            <div className={styles.title}>
                ...
                <div style={{ display: 'flex', gap: '10px' }}>
                    ...
                    <Button
                        ...
                        onClick={() => { resetAlert(_addInstanceModalAlert); setToken(''); setAddInstanceModalActive(true) }}
                    />
                </div>
            </div>
